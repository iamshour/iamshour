...
<table>
  ...
  <!-- BLOG-POST-LIST:START --><tr><td><a href="https://dev.to/iamshour/creating-a-restful-api-easily-using-nodejs-part-3-5hm0">Creating a RESTful API easily using node.js | Part 3</a></td><td>javascript, restapi, node, mongodb</td></tr><tr><td><a href="https://dev.to/iamshour/creating-a-restful-api-easily-using-nodejs-part-2-4l6h">Creating a RESTful API easily using node.js | Part 2</a></td><td>javascript, webdev, restapi, node</td></tr><tr><td><a href="https://dev.to/iamshour/creating-a-restful-api-easily-using-nodejs-part-1-2fh2">Creating a RESTful API easily using node.js | Part 1</a></td><td>javascript, restapi, node, expressjs</td></tr><tr><td><a href="https://dev.to/iamshour/send-emails-from-your-website-to-your-users-it-cant-get-any-easier-p62">Send emails from your website to any user super easily!</a></td><td>javascript, node, nodemailer, emails</td></tr><!-- BLOG-POST-LIST:END -->
</table>
